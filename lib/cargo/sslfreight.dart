...
class Sslfreight extends StatefulWidget {
  final String sacco;
  const Sslfreight({super.key, required this.sacco});

  @override
  _SslfreightState createState() => _SslfreightState();
}

class _SslfreightState extends State<Sslfreight> {
  ...
  Future<void> fetchFleetNumbers() async {
    final url = Uri.parse("https://test-mpay.onrender.com/mpesa/cargo/get_fleet.php?sacco=${widget.sacco}");
  ...
  Future<void> initiatePayment() async {
    ...
    final url = Uri.parse('https://test-mpay.onrender.com/mpesa/cargo/stk_push.php');
