...
class ChurchA extends StatefulWidget {
  final String church;
  const ChurchA({super.key, required this.church});

  @override
  _ChurchAState createState() => _ChurchAState();
}

class _ChurchAState extends State<ChurchA> {
  ...
  Future<void> initiatePayment() async {
    ...
    final url = Uri.parse('https://test-mpay.onrender.com/mpesa/churches/stk_push.php');
