...
class ChurchB extends StatefulWidget {
  final String church;
  const ChurchB({super.key, required this.church});

  @override
  _ChurchBState createState() => _ChurchBState();
}

class _ChurchBState extends State<ChurchB> {
  ...
  Future<void> initiatePayment() async {
    ...
    final url = Uri.parse('https://test-mpay.onrender.com/mpesa/chamas/stk_push.php');
