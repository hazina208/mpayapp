...
class Kinatwa extends StatefulWidget {
  final String sacco;
  const Kinatwa({super.key, required this.sacco});

  @override
  _KinatwaState createState() => _KinatwaState();
}

class _KinatwaState extends State<Kinatwa> {
