...
class Naekana extends StatefulWidget {
  final String sacco;
  const Naekana({super.key, required this.sacco});

  @override
  _NaekanaState createState() => _NaekanaState();
}

class _NaekanaState extends State<Naekana> {
