...
class Foward extends StatefulWidget {
  final String sacco;
  const Foward({super.key, required this.sacco});

  @override
  _FowardState createState() => _FowardState();
}

class _FowardState extends State<Foward> {
