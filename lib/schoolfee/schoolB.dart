...
class SchoolB extends StatefulWidget {
  final String school;
  const SchoolB({super.key, required this.school});

  @override
  _SchoolBState createState() => _SchoolBState();
}

class _SchoolBState extends State<SchoolB> {
  ...
  Future<void> initiatePayment() async {
    ...
    final url = Uri.parse('https://test-mpay.onrender.com/mpesa/schools/stk_push.php');
