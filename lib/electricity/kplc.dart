...
class KplcPower extends StatefulWidget {
  final String agency;
  const KplcPower({super.key, required this.agency});

  @override
  _KplcPowerState createState() => _KplcPowerState();
}

class _KplcPowerState extends State<KplcPower> {
