...
class KengenPower extends StatefulWidget {
  final String agency;
  const KengenPower({super.key, required this.agency});

  @override
  _KengenPowerState createState() => _KengenPowerState();
}

class _KengenPowerState extends State<KengenPower> {
