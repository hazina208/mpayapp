...
class Oscars extends StatefulWidget {
  final String biz;
  const Oscars({super.key, required this.biz});

  @override
  _OscarsState createState() => _OscarsState();
}

class _OscarsState extends State<Oscars> {
