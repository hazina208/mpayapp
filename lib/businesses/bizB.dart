...
class Waltexs extends StatefulWidget {
  final String biz;
  const Waltexs({super.key, required this.biz});

  @override
  _WaltexsState createState() => _WaltexsState();
}

class _WaltexsState extends State<Waltexs> {
  ...
  Future<void> initiatePayment() async {
    ...
    final url = Uri.parse('https://test-mpay.onrender.com/mpesa/businesses/stk_push.php');
